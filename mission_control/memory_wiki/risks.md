...
Keine Tokens, Webhooks, Passwörter oder .env-Inhalte im Klartext ausgeben.
...
Browserdaten enthalten sensible Sitzungen. Nur Metadaten analysieren.

## OpenClaw Binding

Nicht verändern, solange Stack stabil ist.
